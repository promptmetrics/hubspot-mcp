...
allow_regex='^(src/|tests/|bin/|hooks/|skills/|\.claude-plugin/|\.github/|scripts/check-artifact-allowlist\.sh$|docs/architecture\.md$|docs/phase-1-build-plan\.md$|docs/phase-2-build-plan\.md$|docs/hosted-setup\.md$|README\.md$|app\.py$|vercel\.json$|\.vercelignore$|requirements\.txt$|CHANGELOG\.md$|LICENSE$|pyproject\.toml$|\.gitignore$)'
